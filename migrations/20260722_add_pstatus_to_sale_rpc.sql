-- ===========================================================
-- Agregar parámetro p_status a create_sale_with_imeis
-- para soportar ventas pendientes (caja diaria)
-- Cambio mínimo: solo se agrega p_status y status en INSERT
-- ===========================================================
...
create or replace function public.create_sale_with_imeis(
  ...
  p_status text DEFAULT 'vendido'  -- ← NUEVO: 'vendido' | 'pending'
)
returns json
language plpgsql
security definer
